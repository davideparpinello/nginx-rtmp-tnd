...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/">
        <html>
            <head>
                <title>LaTendaTV | RTMP Server statistics</title>
            ...
            <body>
                ...
                <a href="/vod.html">Riproduci flusso RTMP</a>
                <br />
                <br />
                <xsl:apply-templates select="rtmp"/>
                <hr/>
            Generato da La Tenda TV | HLS RTMP Server 
            </body>
        </html>
    </xsl:template>
...
&#160;<xsl:value-of select="meta/audio/profile"/>
    ...
    <td>
        <a href="/vod.html?stream=http://192.168.1.130:8080/hls/{name}.m3u8">Play</a>
    </td>
</tr>
